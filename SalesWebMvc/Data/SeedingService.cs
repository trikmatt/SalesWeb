...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Matheus Valle", "matheus@gmail.com", new DateTime(1994, 6, 29), 2000.0, d1);
            Seller s2 = new Seller(2, "Thomas Silva", "thomas@gmail.com", new DateTime(2020, 4, 04), 2000.0, d2);
            Seller s3 = new Seller(3, "Rebekah Rocha", "rebekah@gmail.com", new DateTime(1998, 3, 11), 2000.0, d3);
            Seller s4 = new Seller(4, "Enzo Rocha", "enzo@gmail.com", new DateTime(2016, 4, 29), 2000.0, d4);
            Seller s5 = new Seller(5, "Ezra Valle", "ezra@gmail.com", new DateTime(1998, 4, 27), 2000.0, d1);
            Seller s6 = new Seller(6, "Daniel Francisco", "daniel@gmail.com", new DateTime(1965, 8, 22), 2000.0, d4);
